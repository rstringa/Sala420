...
?>
  <div class="slider_container">
	...
	?>
      ...
      <div class="slider_inner" style=" background-image: url('<?php echo $large_image_url[0];?>');"> <a href="<?php echo empty( $link_facebook) ? '' : $link_facebook ;?>" target="_blank" title="Mas información en Facebook sobre <?php  echo (trim(strip_tags( $post->post_title )) ); ?>"><img class="rsImg"  src="<?php print THEMEROOT ?>/img/slider_form.png" /></a>
...
<h1 class="sr-only">Teatro en La Plata</h1>
	<div class="row">
...
<div class="box_espec" itemscope itemtype="http://data-vocabulary.org/Event">
<span itemprop="location" class="text-hide sr-only">Sala 420</span>
<div class="card-header">
                <div class="foto_espectaculo">
                     <div class="foto_contenedor">
                    <span itemprop="photo"><?php if ( has_post_thumbnail() ) { the_post_thumbnail(
						'thumbnail', array(
...
<div class="card-block">
 <h5 class="tipo" itemprop="eventType"><?php echo empty( $tipo_esp ) ? '<br>' : $tipo_esp; ?></h5>
            <h3 class="titulo" itemprop="name"><?php the_title(); ?></h3>
            <p><span class="mes"><?php echo empty( $mes_esp ) ? '<br>' : $mes_esp; ?></span> <?php echo empty( $dia_esp ) ? '' : $dia_esp; ?></p> 
</div>
 <div class="bloque_footer" itemscope itemtype="http://schema.org/Offer">
              <a href="<?php echo $link_alternativa; ?>" class="btn btn-secundario" target="_blank" title="Adquirir entradas en Alternativa Teatral" itemprop="seller"><span class="fa fa-ticket fa_left_10"></span>Adquirir Entradas</a>
              <a href="<?php echo $link_facebook; ?>" class="btn btn-secundario" target="_blank" title="Ver más en Facebook" itemprop="description"><span class="fa fa-facebook fa_left_10"></span>Ver más en Facebook</a>
            </div>
...
// Para imprimir por filas
$cant_post=0;
$total_post = $sem_query ->found_posts;
//$total_post = $count_posts->publish;
        ...
        <div class="titulo_seccion col-md-12">
            ...
            <div class="titulo_decoracion"></div>
            	<div class="bg_destacado">
            		<p>Inscribite llamando de <br class="hidden-md-up"><strong>Lunes a Viernes de 16 a 20hs<br class="hidden-md-up"></strong> al <strong><a href="tel:02214893636"> (0221) 489-3636</a></strong><br>o mediante nuestro <a class="js_ir_contacto btn btn-sm  btn-secundario " href="#contacto" onclick="ga('send', 'event', 'slider', 'click', 'Adquirir Entrada');" >Formulario de Contacto</a></p>
				</div>
        </div>
    </div>
...
<?php  
        if( $cant_post == 0 ){ echo '<div class="row js-taller">'; } ?>
...
if (function_exists('rwmb_meta')) {
  	 ...
  	 <div class="col-lg-6 <?php print $cant_post ?>">
   <div class="box clearfix">
       <div class="box_foto">
       
       <a href="#modal-talleres-<?php the_ID(); ?>" data-toggle="modal" title="Mas información"><?php if ( has_post_thumbnail() ) { the_post_thumbnail(
...
<?php 
        // Si termina una fila que la cierre .row
        if( $cant_post == 1 ){ 
			echo '</div>'; $cant_post=0;  
			}
			
		// Si no termina la fila pero es el ultimo que cierre .row	
		elseif ( ($cant_post != 1) && ( ($sem_query->current_post + 1) == $total_post) )  {
		 echo '</div>';
		  	}
    ...
    ?>
<?php }; // Fin While ?>  
<a href="#" id="js-loadMore" class="btn btn-secundario btn_ver_mas" style="display:none;">Ver más Talleres y Seminarios</a> 
</div><!-- fin container -->
</section>
<?php }; // Fin If?>
<?php wp_reset_postdata();?>
...
<div class="row">
        <div class="titulo_seccion col-md-12">
            <h2>Sala 420</h2>
            <div class="titulo_decoracion"></div>
            <div class="titulo_bajada hidden-xs-down" style="text-align:justify;"><?php the_content(); ?></div>
		</div>
<div class="botones_pdf">
    <div class="boton boton_izq">
        <a href="<?php echo site_url(); ?>/documentos/Sala420de1988al2015.pdf" target="_blank" class="btn btn-secundario btn_2_lineas" title="Descargar PDF - 52MB">
        La Historia de Sala 420
        <span>PDF - 52 MB</span>
        </a>
    </div>
    <div class="boton boton_der">
        <a href="#" class="btn btn-secundario btn_2_lineas" target="_blank" title="Descargar PDF - 5MB">
        Documentos Técnicos
        <span>PDF - 5 MB</span>
        </a>
    </div>
...
<span class="fa fa-spinner fa-pulse fa_right_10 js-icono-enviando" style="display:none;"></span></button>
    ...
    <div class="col-lg-4">
       ...
       <p>
       	<span class="fa fa-map-marker fa_left_15"></span>42 entre 6 y 7 n° 571, La Plata<br>
        ...
        Lunes a Viernes de 16 a 20hs<br>
...
<div id="modal-como-llegar" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-body">
    <p>
    <strong>Sala 420</strong><br>

		42 entre 6 y 7 n° 571,<br> 
		B1902AGW La Plata, Buenos Aires<br>
		Argentina.<br>
		+54 (0221) 489-3636<br>
<br>

<strong>Colectivos urbanos</strong><br>

Con parada sobre avenida 7: 273, Norte, 518.<br>

Con parada en Plaza Italia (a dos cuadras de Sala 420): Norte, Sur, Este, Oeste, Talp, 202, 214 (letras A y B), 215, 273, 307, 418, 506, 518.
<br>
<br>

<strong>Colectivos media y larga distancia</strong><br>
Terminal de Ómnibus de la ciudad de La Plata: 42 entre 3 y 4.
<br>
<br>

<strong>Trenes</strong><br>

Estación del Ferrocarril Roca: 1 y 44.
<br>
<br>
...
<div class="design hidden-xs-down">by: <a href="mailto:robertostringa@gmail.com" title="Sitio desarrollado por Roberto Stringa">RS</a></div>
</footer>
<script>
